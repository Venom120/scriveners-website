...
import { symphonyOfMindsFormSchema, SymphonyOfMindsFormValues } from "./SymphonyOfMindsSchema";
import { ProfileFields } from "./ProfileFields";
import { AcademicFields } from "./AcademicFields";
import { EventSelectionFields } from "./EventSelectionFields";
import { useFormSubmission } from "./useFormSubmission";

const SymphonyOfMindsForm = () => {
  // Initialize the form
  const form = useForm<SymphonyOfMindsFormValues>({
    resolver: zodResolver(symphonyOfMindsFormSchema),
    defaultValues: {
      name: "",
      email: "",
      phone: "",
...
export default SymphonyOfMindsForm;
