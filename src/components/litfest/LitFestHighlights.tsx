  ...
  return (
    <div className="container mx-auto px-4 md:px-6 py-8 md:py-16">
      ...
      <div className="text-xl md:text-3xl font-light text-white font-['K2D'] space-y-2">
        ...
        <p>Panel discussions on contemporary literary themes</p>
        <p>Open mic sessions for poets and storytellers</p>
        <p>Networking opportunities with fellow writers and enthusiasts</p>
        <p>Exciting competitions with prizes for the best entries</p>
      </div>
    </div>
  );
};

export default LitFestHighlights;