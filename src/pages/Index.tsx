...
const Index = () => {
  return (
    <main className="bg-[rgba(255,255,255,0.25)] border flex flex-col overflow-hidden items-stretch pl-20 rounded-[20px] border-white border-solid">
      <div className="w-full max-md:max-w-full">
        <div className="flex max-md:flex-col max-md:items-stretch">
          ...
          <div className="w-[10%] ml-5 max-md:w-full max-md:ml-0">
            <div className="bg-[rgba(20,46,56,1)] flex grow flex-col items-center justify-center w-full px-[20px] py-[20px] rounded-[0px_20px_0px_20px] max-md:mt-10 max-md:px-5">
              <img
      ...
      <Hero />
      {typeof window!=="undefined" && window.innerWidth>768 && <Quote />}
